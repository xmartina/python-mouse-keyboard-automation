...
def main_init_strt():
    ...
    # duration_mouse_scroll_d = timeit.timeit(mouse_scroll_d, number=20)
    ...
    # duration_mouse_scroll_u = timeit.timeit(mouse_scroll_u, number=30)
    ...
    duration_mouse_wheel_p_i_u = timeit.timeit(mouse_wheel_p_i_u, number=5)
    ...
    #     time.sleep(1.0 - ((time.time() - starttime) % 1.0))
    #
    # duration_mouse_scroll_u_p_ii = timeit.timeit(mouse_scroll_u_p_ii, number=2)
    #
    ...
    def mouse_to_ads():
        mouse.move(3, 92, absolute=False, duration=.09)
